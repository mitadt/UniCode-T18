...
<br><br>
<center><div style="font-family: Franklin Gothic Book;font-size: 45px;">Basics of Internet Surfing</div><br>
<div style="margin-top: 2%;"><video width="800"  height="480"  controls>
<source src="internet.mp4"  type="video/mp4">
</video>
<br><a href="level1_2.php"><button class="btn">Next</button></a>
</div>
</body>
</html>